                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                         ...
                         <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="customs.php">列表</a>
                                </li>
                            </ul>
                        </li>
                       <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-tachometer-alt"></i>來訪記錄</a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="visits.php">列表</a>
                                </li>
                            </ul>
                        </li>
                         <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-tachometer-alt"></i>客服紀錄</a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                  <li>
                                    <a href="addservice.php">新增</a>
                                </li>
                                <li>
                                    <a href="service.php">列表</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
